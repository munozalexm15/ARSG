...
func enter(_msg := {}):
	...
	if arms.actualWeapon.weaponData.isBoltAction:
		if arms.actualWeapon.weaponData.weaponType == "Sniper":
			...
			SFXHandler.play_sfx_3d.rpc(arms.actualWeapon.bolt_back_sound.stream.resource_path, arms.player.name, "Weapons", 30.0)
	...
	#SMG / AR / Pistols (or anything with a magazine)
		...
		if arms.actualWeapon.weaponData.bulletsInMag > 0:
			...
			SFXHandler.play_sfx_3d.rpc(arms.actualWeapon.reload_sound.stream.resource_path, arms.player.name, "Weapons", 30.0)
			...
			SFXHandler.play_sfx_3d.rpc(arms.actualWeapon.full_reload_sound.stream.resource_path, arms.player.name, "Weapons", 30.0)
...
func physics_update(_delta):
	...
	if Input.is_action_just_pressed("Fire") and arms.actualWeapon.weaponData.isBoltAction:
		...
		if arms.actualWeapon.weaponData.weaponType == "Sniper":
			...
			SFXHandler.play_sfx_3d.rpc(arms.actualWeapon.bolt_forward_sound.stream.resource_path, arms.player.name, "Weapons", 30.0)
			await arms.actualWeapon.handsAnimPlayer.animation_finished
